...
void initialize_astar(ModuleInitializationLevel p_level)
{
...
extern "C"
{
    GDExtensionBool GDE_EXPORT a_star_library_init(
        ...
        GDExtensionInitialization *r_initialization)
    {
        ...
        init_obj.register_initializer(initialize_astar);
        init_obj.register_terminator(uninitialize_astar);
